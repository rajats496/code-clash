...
export async function runLoadTest() {
  ...
  // Give the server event loop a breather before the join-contest storm
  log(`Waiting ${CONFIG.JOIN_PHASE_DELAY_MS}ms before starting join-contest phase...`);
  await sleep(CONFIG.JOIN_PHASE_DELAY_MS);
