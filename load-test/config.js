...
export const CONFIG = {
  ...
  JOIN_STAGGER_MS: parseInt(process.env.LOADTEST_JOIN_STAGGER_MS, 10) || 200,

  /** After all sockets connect, wait this many ms before starting join-contest phase (event-loop breather) */
  JOIN_PHASE_DELAY_MS: parseInt(process.env.LOADTEST_JOIN_PHASE_DELAY_MS, 10) || 5000,
