...
import { LightningIcon, FlameIcon, TrophyIcon, SparklesIcon, CopyIcon, ClockIcon, ArrowRightIcon, CheckIcon } from '../components/common/Icons';
...
const Matchmaking = () => {
  ...
  const roundOptions = [
    { value: 1, label: 'Quick 1v1', desc: 'Single question', icon: <LightningIcon size={24} className="text-[#ffa116]" /> },
    { value: 3, label: 'Best of 3', desc: 'Standard match', icon: <FlameIcon size={24} className="text-orange-500" /> },
    { value: 5, label: 'Best of 5', desc: 'Epic showdown', icon: <TrophyIcon size={24} className="text-yellow-400" /> },
    { value: 7, label: 'Best of 7', desc: 'Ultimate battle', icon: <SparklesIcon size={24} className="text-purple-400" /> },
  ];
          ...
          {!inQueue && (
            <div className="flex gap-1 mb-6 p-1 rounded-xl bg-slate-800/60 border border-slate-700/40 w-fit">
              <button
                ...
                className={`px-5 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'ranked'
                  ? 'bg-gradient-to-r from-orange-500 to-red-600 text-white shadow-lg shadow-orange-500/30'
                  : 'text-slate-400 hover:text-slate-200'
                  }`}
              >
                <span className="flex items-center justify-center gap-2"><TrophyIcon size={18} /> Ranked Match</span>
              </button>
              <button
                onClick={() => setActiveTab('private')}
                className={`px-5 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'private'
                        ...
                        <div>
                          ...
                          <div className="flex items-center justify-center gap-3">
                            ...
                            <button
                              ...
                              className={`px-4 py-3 rounded-xl border text-sm font-bold transition-all ${codeCopied
                                ? 'border-emerald-500/50 bg-emerald-500/15 text-emerald-400'
                                : 'border-slate-600/50 bg-slate-800/50 text-slate-300 hover:border-purple-400/50 hover:text-purple-300'
                                }`}
                            >
                              {codeCopied ? <span className="flex items-center gap-1"><CheckIcon size={16} /> Copied!</span> : <span className="flex items-center gap-1"><CopyIcon size={16} /> Copy</span>}
                            </button>
                          </div>
                        </div>
                      ...
                      <>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              {roundOptions.map((opt) => (
                                <button
                                  ...
                                  className={`p-3 rounded-lg border-2 transition-all text-center text-sm ${selectedRounds === opt.value
                        ...
                        <div className="lc-card rounded-xl border border-blue-500/30 bg-slate-800/40 p-6 space-y-4 shadow-lg">
                          ...
                          <div className="flex gap-2">
                            ...
                            >
                              {privatePhase === 'joining' ? <ClockIcon size={18} className="animate-spin" /> : <span className="flex items-center gap-1">Join <ArrowRightIcon size={16} /></span>}
                            </button>
                          </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div className="lc-card p-4 rounded-lg border border-slate-700/50 bg-slate-800/40 backdrop-blur border-l-4 border-l-orange-500 hover:shadow-lg transition-all">
                          <h3 className="font-bold text-slate-50 mb-1 text-sm flex items-center gap-2"><LightningIcon size={18} className="text-[#ffa116]" /> Lightning Fast Matching</h3>
                        ...
                        <div className="lc-card p-4 rounded-lg border border-slate-700/50 bg-slate-800/40 backdrop-blur border-l-4 border-l-blue-500 hover:shadow-lg transition-all">
                          <h3 className="font-bold text-slate-50 mb-1 text-sm flex items-center gap-2"><TrophyIcon size={18} className="text-blue-500" /> Competitive Ranking</h3>
                      ...
                      >
                        <span className="relative z-10 flex items-center justify-center gap-2">
                          ...
                          {selectedRounds && <LightningIcon className="group-hover:scale-110 transition-transform text-[#ffa116]" size={20} />}
                        </span>
